...
func (o *FriendStatsOK) Error() string {
	return fmt.Sprintf("[GET /stats/cod/v1/title/{title}/platform/{platform}/{lookupType}/{gamertag}/profile/friends/type/{gameType}][%d] friendStatsOK  %+v", 200, o.Payload)
}
...
func (o *FriendStatsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.FriendStatsResponse)
