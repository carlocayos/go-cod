...
func (o *PurchasableOK) Error() string {
	return fmt.Sprintf("[GET /inventory/v1/title/{title}/platform/{platform}/purchasable][%d] purchasableOK  %+v", 200, o.Payload)
}
...
func (o *PurchasableOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.PurchasableResponse)
